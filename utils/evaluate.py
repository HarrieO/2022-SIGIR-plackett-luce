...
def evaluate_expected(data_split, scores, rank_weights, labels, ideal_metrics, num_samples):
  cutoff = rank_weights.size
...
def compute_results(data_split, model, rank_weights,
  ...
  return compute_results_from_scores(
            data_split, scores, rank_weights,
            labels, ideal_metrics, num_samples)

def compute_results_from_scores(data_split, scores, rank_weights,
                    labels, ideal_metrics, num_samples):
